...
def forgot_password(request):
    if request.method == 'POST':
        ...
        html_content = render_to_string('auctions/mail/new_password_mail.html', {'username': username, 'password': new_password})

        send_mail(
            'Your new password',
            'Use the following password to login to your account:',
            'auctionhaven33@gmail.com',
            [email],
...
def password_reset_success(request):
    return render(request, 'auctions/authentication/reset.html')
